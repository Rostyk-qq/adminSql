    ...
    if($request['action'] === 'delete'){
        if($res = $sqlMain->deleteEntry($request)){
            if(gettype($res) === 'integer'){
                ...
                echo json_encode(['status' => false, 'message_permission' => "You don't have permission to delete!"]);
            }
        }
        die();
    }
    ...
    if(!empty($errors)){
        ...
        if($request['action'] === 'add'){
            ...
            if(gettype($res) === 'integer'){
                ...
                echo json_encode(['status' => false, 'message_permission' => "You don't have permission to add!"]);
            }
        }
        else{
            ...
            if(gettype($res) === 'integer'){
                ...
                echo json_encode(['status' => false, 'message_permission' => "You don't have permission to update!"]);
            }
        }
    }
}