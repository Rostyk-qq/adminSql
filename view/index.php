...
<body>
    <div class="container-md mt-4 position-relative">
        ...
        <div id="alert_permission" style="z-index:3;top: 10px;" class="position-fixed start-50 end-0 me-2 alert alert-warning d-flex justify-content-between d-none" role="alert">
            <strong class="text-custom">Warning, <?php echo $_GET['username']; ?>!</strong>
            <span class="text-custom" id="permission_message"></span>
        </div>
